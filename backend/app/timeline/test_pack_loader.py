...
class TestPackLoader:
    ...
    def get_candidate_dirs(cls, pack_name: str) -> List[str]:
        ...
        ws_data_files = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "data_files", pack_name))
        return [
            ws_data_files,
            os.path.join(base_dir, "data_files", pack_name),
            os.path.join(base_dir, pack_name),
            os.path.join(os.getcwd(), "data_files", pack_name),
